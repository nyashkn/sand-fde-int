...
Living reference produced by the `conceptual-model` change. Companion to
`spec.md` in this directory — that file holds the requirements, this one holds the model.
