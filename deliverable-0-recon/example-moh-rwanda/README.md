...
```
artifacts/
  moh-rwanda-architecture.html          # FINAL artifact — 45 source links, vision verdict "Acceptable"
  moh-rwanda-architecture.baseline.html # first render, pre-links (for the before/after story)
